...
namespace school {
    ...
    public partial class schoolDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TeacherDataTable : global::System.Data.TypedTableBase<TeacherRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TeacherRow AddTeacherRow(int ID, string Name, int Number) {
        ...
        public partial class TeacherRow : global::System.Data.DataRow {
            ...
            public int Number {
                get {
                    try {
                        return ((int)(this[this.tableTeacher.NumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Number\' in table \'Teacher\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTeacher.NumberColumn] = value;
                }
            }
            ...
            public bool IsNumberNull() {
                return this.IsNull(this.tableTeacher.NumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetNumberNull() {
                this[this.tableTeacher.NumberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace school.schoolDataSet1TableAdapters {
    ...
    public partial class TeacherTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Teacher] WHERE (([ID] = @Original_ID) AND ((@IsNull_Number = 1" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Teacher] ([ID], [Name], [Number]) VALUES (@ID, @Name, @Number)" +
                ";\r\nSELECT ID, Name, Number FROM Teacher WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Teacher] SET [ID] = @ID, [Name] = @Name, [Number] = @Number WHERE (" +
                "([ID] = @Original_ID) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number" +
                "] = @Original_Number)));\r\nSELECT ID, Name, Number FROM Teacher WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Number FROM dbo.Teacher";
        ...
        public virtual int Fill(schoolDataSet1.TeacherDataTable dataTable) {
        ...
        public virtual schoolDataSet1.TeacherDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            schoolDataSet1.TeacherDataTable dataTable = new schoolDataSet1.TeacherDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(schoolDataSet1.TeacherDataTable dataTable) {
        ...
        public virtual int Insert(int ID, string Name, global::System.Nullable<int> Number) {
        ...
        public virtual int Update(int ID, string Name, global::System.Nullable<int> Number, int Original_ID, global::System.Nullable<int> Original_Number) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Number, int Original_ID, global::System.Nullable<int> Original_Number) {
            return this.Update(Original_ID, Name, Number, Original_ID, Original_Number);
        }
    }
